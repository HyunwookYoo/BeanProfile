...
관련 문서: 설계 [`../design.md`](../design.md) · 목업 [`../mockups/ui-mockup-v1.html`](../mockups/ui-mockup-v1.html)

| # | 마일스톤 | 완료 시 동작하는 것 | 상세 계획 |
|---|---|---|---|
| **M1** | 기반 & 원두 추가/조회 | Flutter 프로젝트 · 테마/3탭 셸 · drift DB(3테이블) · 원두 **수동 추가 → 리스트 → 상세(읽기)** | [`milestone-1-foundation.md`](milestone-1-foundation.md) ✅ 작성됨 |
